...
public class AccountControllerTests {
    ...
    public void createAccount_with_USER_role_should_return_403() throws Exception {
    	Account testAccount = new Account("1234512345", "Mary Jones");
    	// arrange nothing, because the Principal is not allowed to perform the operation
    	...
    	//verify nothing, because the Principal is not allowed to perform the operation
