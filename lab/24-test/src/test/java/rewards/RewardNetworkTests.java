...
//@SpringJUnitConfig(classes=TestInfrastructureConfig.class) // Using an external class
@SpringJUnitConfig() // Tell Spring to search for a static inner class annotated with @Configuration 
